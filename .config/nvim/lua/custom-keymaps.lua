...
nmap('<C-h>', ':TmuxNavigateLeft<cr>', { noremap = true, silent = true })
...
nmap('<leader>j', ':bp<CR>', { silent = true, noremap = true, desc = "Next buffer" })
nmap('<leader>k', ':bn<CR>', { silent = true, noremap = true, desc = "Next buffer" })
nmap('<leader>n', "<cmd>NvimTreeFindFile<cr>", { noremap = true, desc = "Tree reveal" })
